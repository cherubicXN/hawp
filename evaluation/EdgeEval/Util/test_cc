...
#include "Matrix.hh"
#include "Matrix.cc" //friend functions aren't visible until they are defined
#include "Timer.hh"
...
main ()
{
    ...
    { // filling
        ...
        //TODO: this test now fails for some reason.
        //presumably some problem with accuracy in linspace?
